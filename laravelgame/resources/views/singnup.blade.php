                            ...
                            <div class="card-body p-4">
                                ...
                                <form action="{{ route('register') }}" method="post">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="email" name="email" id="" required placeholder="Enter your email">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control" type="password"  name="password_confirmation" required id="" placeholder="Enter your password">
                                    </div>
